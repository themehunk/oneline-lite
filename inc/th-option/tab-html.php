...
<div class="th-option-area">
        <div class="th-option-top-hdr">
            <div class="col-1">
                <div class="logo-img">
                <a target="_blank" href="<?php echo $theme_header['theme_brand_url']; ?>/?wp=oneline-lite" class=""> <span class="logo-image"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/th-option/assets/images/icon.png"/><?php echo $theme_header['theme_brand']; ?></span></a>
            </div>
            </div>
            <div class="col-2">
        ...
        <div class="th-option-bottom-hdr">
            ...
            <a class="tablinks" onclick="openTab(event, 'Recommended-Plugin')"><?php _e('Recommended Plugin','oneline-lite');?> </a>
            <a class="tablinks" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Demo Import','oneline-lite');?> </a>
            <a class="tablinks get-child" onclick="openTab(event, 'Get-Child-Theme')"><?php _e('Get Child Theme','oneline-lite');?></a>
          ...
          <div id="Import-Demo-Content" class="tabcontent">
            ...
            <div class="rp-two-column">
                ...
                <h3><?php _e('Click Here To Import Demo Content','oneline-lite'); ?></h3>
				 ...
				 <p> <?php _e('You need to Install required plugins like- Themehunk Customizer, WooCommerce and One click demo import plugin. After installing required plugins import button will activate.', 'oneline-lite'); ?></p>
